...
ENEMY_EQUIPS_URL = 'http://kancolle.wikia.com/api.php?action=query&list=categorymembers&cmtitle=Category:Enemy_equipment_modules&cmlimit=500&format=json'
